...
<html lang="en">
  <head>
	...
	href="${pageContext.request.contextPath}/resources/css/main/styles.css">
    <style>
    #view-source {
      position: fixed;
      display: block;
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="mdl-layout__header-row">
          ...
          <div class="android-navigation-container">
            <nav class="android-navigation mdl-navigation">
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Sorting</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Searching</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Greedy</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Dynamic</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Graph</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Tree</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Strings</a>
            </nav>
          </div>
      ...
      <div class="android-drawer mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
          <a class="mdl-navigation__link" href="">Sorting</a>
          <a class="mdl-navigation__link" href="">Searching</a>
          <a class="mdl-navigation__link" href="">Greedy</a>
          <a class="mdl-navigation__link" href="">Dynamic</a>
          <a class="mdl-navigation__link" href="">Graph</a>
          <a class="mdl-navigation__link" href="">Tree</a>
          <a class="mdl-navigation__link" href="">Strings</a>
          ...
          <div class="android-card-container mdl-grid">
            <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Sorting Algorithms</h4>
              </div>
<!--               <div class="mdl-card__supporting-text"> -->
<!--                 <span class="mdl-typography--font-light mdl-typography--subhead">Four tips to make your switch to Android quick and easy</span> -->
<!--               </div> -->
<!--               <div class="mdl-card__actions"> -->
<!--                  <a class="android-link mdl-button mdl-js-button mdl-js-ripple-effect mdl-typography--text-uppercase" href=""> -->
<!--                    Make the switch -->
...
<!--               </div> -->
            ...
            <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Searching Algorithms</h4>
              </div>
<!--               <div class="mdl-card__supporting-text"> -->
...
<!--               </div> -->
            ...
            <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Greedy</h4>
              </div>
<!--               <div class="mdl-card__supporting-text"> -->
...
<!--               </div> -->
            ...
            <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Dynamic Programming</h4>
              </div>
<!--               <div class="mdl-card__supporting-text"> -->
